...
| 👤 **Профили пользователей** | Имена, аватарки и описание |
| 🟢 **Онлайн-статус** | Видно, кто сейчас в сети |
| ✍️ **"Печатает..."** | Индикатор набора текста |
| 🖼️ **Отправка медиа** | Фото и файлы через Supabase Storage |
| ❤️ **Реакции** | Эмодзи-реакции на сообщения |
| 🗑️ **Управление чатами** | Создание и удаление чатов |
| 🌓 **Тёмная/светлая тема** | Переключение с iOS-тогглером |
...
| **Хранилище** | Supabase Storage (аватарки, файлы) |
